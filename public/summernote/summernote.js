  ...
  var EventHandler = function () {
    ...
    var hToolbarAndPopoverClick = function (event) {
      ...
      if ($btn.length > 0) {
        ...
        } else if (sEvent === 'showMediaLibraryDialog') {
  ...
  var Renderer = function () {
    ...
    tplToolbarInfo = {
      medialibrary: function (lang) {
        return '<button type="button" class="btn btn-default btn-sm btn-small" title="Media Library" data-event="showMediaLibraryDialog" tabindex="-1"><i class="fa fa-picture-o icon-picture"></i></button>';
      },
