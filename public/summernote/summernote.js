...
(function (factory) {
  ...
  var Editor = function () {
    ...
    this.createLink = function ($editable, sLinkText, sLinkUrl, bNewWindow) {
      ...
      if (sLinkUrl.indexOf('@') !== -1 && sLinkUrl.indexOf(':') === -1) {
        ...
        sLinkUrlWithProtocol = sLinkUrlWithProtocol;
  ...
  var Popover = function () {
    ...
    this.update = function ($popover, oStyle, isAirMode) {
      ...
      if (oStyle.anchor) {
        ...
        $anchor.attr('href', oStyle.anchor.href).html($(oStyle.anchor).attr('href'));
  ...
  var Dialog = function () {
    ...
    this.showMediaLibraryDialog = function($editable, $dialog) {
  ...
  var EventHandler = function () {
    ...
    var commands = {
      ...
      showMediaLibraryDialog: function (oLayoutInfo) {
  ...
  var Renderer = function () {
    ...
    var tplButtonInfo = {
      medialibrary: function (lang) {
        return tplIconButton('fa fa-picture-o icon-picture', {
          event: 'showMediaLibraryDialog',
    ...
    var tplDialogs = function (lang, options) {
      ...
      var tplMediaLibraryDialog = function () {
        
        var body = '<div class="row medialibrary-list">' +
        ...
        // return '<div class="note-medialibrary-dialog modal" aria-hidden="false">' +
        //          '<div class="modal-dialog">' +
        //            '<div class="modal-content">' +
        //              '<div class="modal-header">' +
        //                '<button type="button" class="close" aria-hidden="true" tabindex="-1">&times;</button>' +
        ...
        //        '</div>';
          ...
          return tplDialog('note-medialibrary-dialog', lang.image.insert, body, footer);               
      };
