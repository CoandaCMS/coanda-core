(function ($) {
	...
	$.fn.slugify = function (target, options) {
		var $source = this;
		var $targets = $(target);
		...
		var updateSlug = function () {
			...
			$targets.each ( function () {
				...
				if (!$(this).hasClass('slugify-locked'))
				{
					$(this).val(slug);	
				}
		...
		$targets.each( function () {
			...
			$(this).change( function () {
				...
				if ($(this).val() == '')
				{
					$(this).removeClass('slugify-locked');
				}
				else
				{
					$(this).addClass('slugify-locked');	
		...
		$('.refresh-slug').each ( function () {
			...
			$(this).on('click', function () {
				...
				$(this).parents('.input-group').find($target_class).val(slug);
				$(this).parents('.input-group').find($target_class).removeClass('slugify-locked');
