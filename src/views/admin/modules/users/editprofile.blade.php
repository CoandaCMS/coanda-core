...
<div class="row">
	<div class="page-name col-md-12">
		<h1 class="pull-left">Edit your profile</h1>
	</div>
</div>
...
<div class="row">
	<div class="col-md-12">
		...
		<div class="edit-container">
			...
			{{ Form::open(['url' => Coanda::adminUrl('users/edit-profile')]) }}
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group @if (isset($invalid_fields['password'])) has-error @endif">
						    ...
						    @else
						    	<span class="help-block">If you do not wish to change your password, just leave these fields blank.</span>
						    @endif
						</div>
					</div>
					<div class="col-md-6">
